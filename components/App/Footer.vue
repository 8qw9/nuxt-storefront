<template>
    <footer>
        <div
            class="bg-white px-4 pt-24 pb-4 sm:px-6 lg:px-8 border-t border-ui-medium flex items-center justify-between text-sm">
            ...
            <div class="flex items-center">
                ...
                <a href="https://www.twitter.com/medusajs"
                    class="mr-3 last:mr-0 text-ui-dark hover:text-gray-700">Twitter</a>
